    ...
    <div className="fixed inset-0 z-50 flex">
      ...
      <div className="absolute right-0 top-0 bottom-0 w-[600px] bg-white shadow-xl flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">审批单详情</h3>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {/* 预算信息 */}
          <Card className="p-4">
            <h4 className="text-sm font-medium text-gray-900 mb-4">预算信息</h4>
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
...
// --------------- 页面主体 ---------------
function ExpenseApprovalDetail() {
...
// 默认导出
export default function ExpenseFactPage() {
